...
const SecondaryMarket: React.FC = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Secondary Market</h1>
        <p className="text-gray-600 mt-1">Trading activity and market analytics</p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="p-6">
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Order book will appear here when trading begins</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="p-6">
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No recent trades</h3>
              <p className="text-gray-600">Trade history will appear here</p>
            </div>
          </div>
        </div>
      </div>
